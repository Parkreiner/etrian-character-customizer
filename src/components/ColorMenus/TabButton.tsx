...
const tabButtonStyles = cva(
  "px-3.5 py-1 rounded-full text-sm flex flex-row flex-nowrap gap-x-1 items-center first:pl-4 last:pr-4 transition-colors duration-150",
  {
    variants: {
      active: {
        true: "text-opacity-100 text-teal-950 bg-teal-100 font-medium",
        false:
          "text-opacity-95 text-teal-50 bg-teal-900 hover:bg-teal-100 hover:text-teal-950",
